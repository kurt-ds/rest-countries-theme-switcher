...
const ThemeButton: React.FC = () => {
  ...
  return (
    <button onClick={toggleTheme} className="text-body flex items-center gap-2" >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="fill-body h-[16px]" >
